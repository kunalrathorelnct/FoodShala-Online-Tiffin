...
$query=$this->db->query("select rest.restaurant_name,rest_dish.* from restaurants as rest inner join restaurants_dish as rest_dish on rest.user_id=rest_dish.restaurant_user_id order by id DESC LIMIT 0, 30");
return $query->result();
}
